...
/>
      ...
      <main className="bg-gray-900 text-white px-6 py-20 text-center min-h-screen flex flex-col items-center justify-center">
        ...
        <p className="text-xl md:text-2xl max-w-2xl mb-10 text-gray-300">
          ...
          This isn’t motivation. This is wiring.
        </p>
      ...
      💬 Message from the Founder
        ...
        <section className="mt-20 max-w-3xl text-left space-y-6">
          ...
          <p className="text-lg text-gray-300">
            <strong>Myelin doesn’t care about your intentions.</strong> It doesn’t respond to promises, motivation, or positive thinking.
            <br />
        ...
        <section className="mt-20 max-w-3xl text-left space-y-6">
          ...
          <p className="text-lg text-gray-300">
            I’m <strong>Chad Adams Drummonds</strong> — a father, husband, and computer science student who lost everything to addiction...
            and clawed my way back.
          </p>
          <p className="text-lg text-gray-300">
            After nearly 20 years stuck in cycles I couldn’t break, I found the truth in neuroscience:
        ...
        <section className="mt-20 max-w-3xl text-left space-y-6">
          <h2 className="text-3xl font-bold text-white">💡 What You’ll Find Here</h2>
