    ...
    <footer className="text-center p-8 bg-gray-900 text-white text-sm">
      ...
      <div className="space-y-2 mb-4">
        ...
        <p className="text-gray-400 mt-2">
                    Special thanks to Matt Stewart — your belief helped light
          this path.        {" "}
        </p>
               {" "}
        <p>
      ...
      <main className="bg-gray-900 text-white min-h-screen">
        ...
        <section className="relative overflow-hidden pt-20 pb-40 text-center flex flex-col items-center justify-center min-h-[80vh] px-6">
          ...
          <div className="relative z-10 max-w-4xl mx-auto">
            ...
            <p className="text-xl md:text-2xl max-w-2xl mb-10 text-gray-300 animate-slide-up delay-200">
                            Welcome to <strong>Myelin Map</strong> — a tool for
              transformation               built on the neuroscience of action
              and repetition. This isn&apos;t               motivation. This is
              wiring.            {" "}
            </p>
                       {" "}
        ...
        <HomeSection title="🧠 Why Myelin Matters">
          ...
          <p className="text-lg text-gray-300">
                        Myelin is the brain&apos;s insulation. It speeds up
            signals, strengthens             connections, and makes habits
            automatic.             <br />            Every time you take action,
            you build myelin. Every rep counts. This             is how you
            change your life.          {" "}
          </p>
                 {" "}
        </HomeSection>
        ...
        <HomeSection title="📜 The Myelin Truth">
          ...
          <p className="text-lg text-gray-300">
            ...
                        doesn&apos;t respond to promises, motivation, or
            positive thinking. It             only cares about what you do — and
            how often you do it.          {" "}
          </p>
                   {" "}
          <p className="text-lg text-gray-300">
                        Every time you take focused action, a neural circuit
            fires. When it             fires, myelin wraps it — strengthening,
            speeding, locking it in.             This is how skills form. This
            is how change happens. This is how you             become
            unstoppable.          {" "}
          </p>
                 {" "}
        </HomeSection>
        ...
        <HomeSection title="⚡ My Story">
                   {" "}
          <p className="text-lg text-gray-300">
                        I&apos;m <strong>Chad Drummonds</strong> — a father,
            husband, and             computer science student who lost
            everything to addiction... and             clawed my way back.      
               {" "}
          </p>
                   {" "}
          <p className="text-lg text-gray-300">
                        After nearly 20 years stuck in cycles I couldn&apos;t
            break, I found the             truth in neuroscience: The brain can
            change. But only through             action.          {" "}
          </p>
                   {" "}
          <p className="text-lg text-gray-300">
                        I built Myelin Map to help people like me — people who
            are sick of             failing silently — finally <em>see</em>{" "}
            their growth. Not with empty             checkmarks, but with real,
            visual feedback grounded in how the brain             works.        
             {" "}
          </p>
                 {" "}
        </HomeSection>
        ...
        <section className="text-center py-20 px-6 bg-gray-800">
          ...
          <p className="text-lg text-gray-300 mb-6 max-w-xl mx-auto">
                        Take the first step toward building the life you want.
            The journey             starts with a single rep.          {" "}
          </p>
                   {" "}
