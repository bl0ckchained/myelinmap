          ...
          <div>
            ...
            <ul className="list-disc list-inside space-y-2 text-gray-300">
              <li>
                ...
                - Explore how the brain builds skills.
              </li>
              <li>
                <a
                ...
                - Book and tools by Charles Duhigg.
              </li>
              <li>
                <a
                ...
                - Daniel Coyle reveals how deep practice and myelin growth
              ...
              <li>
                ...
                - Oprah & Dr. Perry explore trauma, healing, and brain rewiring
                through compassion.
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="list-disc list-inside space-y-2 text-gray-300">
              <li>
                ...
                - 1-800-662-HELP (Free, 24/7 treatment support)
              </li>
              <li>
                <a
                ...
                - Find meetings and recovery tools.
              </li>
              <li>
                <a
          ...
          <div>
            ...
            <ul className="list-disc list-inside space-y-2 text-gray-300">
              <li>
                ...
                * A place of hope, growth, and transformation. This is where my
              ...
              <li>
                ...
                - Free education in math, science, and more.
              </li>
              <li>
                <a
          ...
          <div>
            ...
            <ul className="list-disc list-inside space-y-2 text-gray-300">
              <li>
                ...
                - Resources on shame, vulnerability, and courage.
              </li>
              <li>
                <a
                ...
                - Meditate, reflect, and reconnect — anytime, anywhere.
              </li>
            </ul>
          </div>
